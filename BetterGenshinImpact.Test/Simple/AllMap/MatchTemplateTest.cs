...
public class MatchTemplateTest
{
    ...
    {
        var tar = new Mat(@"E:\HuiTask\更好的锄地\地图匹配\比较\叠图\无法匹配.png", ImreadModes.Grayscale);
        var sTar = tar.Resize(new Size(240, 135), 0, 0, InterpolationFlags.Cubic);
        // sTar = new Mat(sTar, TemplateSizeRoi);
        Cv2.ImShow("sTar", sTar);
        var src = new Mat(@"E:\HuiTask\更好的锄地\地图匹配\combined_image_small.png", ImreadModes.Grayscale);
        var src2 = src.Clone();
        ...
        Cv2.ImWrite(@"E:\HuiTask\更好的锄地\地图匹配\x1.png", src2);
    }

    public static void TestTrack()
    {
        var tar = new Mat(@"E:\HuiTask\更好的锄地\自动剧情\任务剧情与地图追踪\blue_task_point_28x.png", ImreadModes.Grayscale);
        var src = new Mat(@"E:\HuiTask\更好的锄地\自动剧情\任务剧情与地图追踪\202404050232291883.png", ImreadModes.Grayscale);
        var src2 = src.Clone();
        ...
        Cv2.ImWrite(@"E:\HuiTask\更好的锄地\自动剧情\任务剧情与地图追踪\rec_b1.png", src2);
    }
    ...
    public static void TestMenu()
    {
        ...
        var src = new Mat(@"E:\HuiTask\更好的锄地\地图匹配\比较\菜单\Clip_20240331_155210.png", ImreadModes.Color);
        var src2 = src.Clone();
        ...
        Cv2.ImWrite(@"E:\HuiTask\更好的锄地\地图匹配\比较\菜单\rec2.png", src2);
    }

    public static void TestTeamAvatar()
    {
        var tar = new Mat(@"E:\HuiTask\更好的锄地\自动秘境\自动战斗\队伍识别\识别头像素材\UI_AvatarIcon_Side_Zhongli_2.png", ImreadModes.Unchanged);
        ...
        var src = new Mat(@"E:\HuiTask\更好的锄地\自动秘境\自动战斗\队伍识别\1.png", ImreadModes.Color);
        var src2 = src.Clone();
        var p = MatchTemplateWithGaussianBlur(src, tar, TemplateMatchModes.CCoeffNormed, null, 0.1);
        Cv2.Rectangle(src2, new Rect(p.X, p.Y, tar.Width, tar.Height), new Scalar(0, 0, 255), 1);
        // Cv2.ImWrite(@"E:\HuiTask\更好的锄地\自动秘境\自动战斗\队伍识别\rec_1.png", src2);
