...
public class ScaleTest
{
    ...
    {
        var mainMap2048BlockMat = new Mat(@"E:\HuiTask\更好的锄地\地图匹配\有用的素材\5.0\mainMap2048Block.png", ImreadModes.Color);
        // 缩小 2048/512 = 4
        var targetFilePath = @"E:\HuiTask\更好的锄地\地图匹配\有用的素材\5.0\mainMap1024BlockColor.png";
        // opencv 缩小
