    ...
    private static readonly IHost _host = Host.CreateDefaultBuilder()
        ...
        .ConfigureServices(
            (context, services) =>
            {
                ...
                services.AddView<AutoTpPage, AutoTpPageViewModel>();
                services.AddView<RoutePage, RoutePageViewModel>();
                services.AddView<PickPage, PickPageViewModel>();
