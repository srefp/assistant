...
public class PathingTask
{
    ...
    public static PathingTask BuildFromFilePath(string filePath)
    {
        ...
        {
            TaskControl.Logger.LogError("路径追踪任务 {Name} 版本号要求 {BgiVersion} 大于当前 耕地机 版本号 {CurrentVersion} ， 脚本可能无法正常工作，请更新 Assistant 版本！", task.FileName, task.Info.BgiVersion, Global.Version);
        }
        return task;
    }
